...
/* #3- How many copies of the book titled "The Lost Tribe" are owned by the library branch whose name is "Sharpstown"? */
...
SELECT Borrower.borrower_BorrowerName AS Borrower_Name, Borrower.borrower_BorrowerAddress AS Borrower_Address,
		   ...
		   HAVING COUNT(Borrower.borrower_BorrowerName) >= 1;
           
/* #5- For each book authored by "Stephen King", retrieve the title and the number of copies owned by the library branch whose name is "Central".*/
